...
var Logger = new _utils.LoggerFactory("progress.bar", { level: "debug" });
...
var Component = function (_React$Component) {
    ...
    _createClass(Component, [{
        ...
        value: function componentDidMount() {
            ...
            if (this.props.animateOnMount) {
                this.animationTimer = setTimeout(function () {
                    _this3.requestAnimationFrame = window.requestAnimationFrame(function () {
                        _this3.setState({
        ...
        value: function render() {
            ...
            var size = _utils.Style.getSize(scale);
            var strokeWidth = _utils.Style.getSize(this.props.strokeWidth);
            var linecap = strokeLinecap != "butt" ? strokeWidth / 2 : 0;
            var left = linecap;
            var trailRight = size - linecap;
            var pathRight = size * (rate / 100) - linecap;

            var sizeWithUnit = _utils.Style.setUnit(size);
            var dashOffsetWithunit = _utils.Style.setUnit(size * (100 - rate) / 100);

            logger.debug("data", {
                rate: rate, size: size, strokeWidth: strokeWidth, linecap: linecap, left: left, trailRight: trailRight, pathRight: pathRight, sizeWithUnit: sizeWithUnit, dashOffsetWithunit: dashOffsetWithunit
            });
            ...
            return _react2.default.createElement(
                ...
                { className: _styles2.default.progress,
                    width: size,
                    height: strokeWidth },
                _react2.default.createElement("path", { className: _styles2.default.trail,
                    d: "M " + left + "," + strokeWidth / 2 + " L " + trailRight + "," + strokeWidth / 2,
                    strokeWidth: strokeWidth,
                    fillOpacity: 0,
                    style: trailStyle }),
                _react2.default.createElement("path", { className: _styles2.default.path,
...
Component.propTypes = {
    rate: _react2.default.PropTypes.number.isRequired,
    strokeWidth: _react2.default.PropTypes.number,
    widthScale: _react2.default.PropTypes.number,
    heightScale: _react2.default.PropTypes.number,
    animateOnMount: _react2.default.PropTypes.bool,
    strokeColor: _react2.default.PropTypes.string,
    strokeLinecap: _react2.default.PropTypes.oneOf(["butt", "round", "square"]),
...
var Logger = new _utils.LoggerFactory("progress.radial", { level: "debug" });
...
var Component = function (_React$Component) {
    ...
    _createClass(Component, [{
        ...
        value: function render() {
            ...
            var size = _utils.Style.getSize(scale);
            var halfSize = size / 2;
            var width = Math.round(size / 5);

            var radius = (size - width) / 2;
            var circumference = 2 * Math.PI * radius;
            var circumferenceWithUnit = _utils.Style.setUnit(circumference);
            var dashOffsetWithunit = _utils.Style.setUnit((100 - rate) / 100 * circumference);

            logger.debug("data", {
                size: size, width: width, radius: radius, circumference: circumference,
                circumferenceWithUnit: circumferenceWithUnit, dashOffsetWithunit: dashOffsetWithunit
            });
...
Component.displayName = "progress.radial";
Component.defaultProps = {
    rate: 0,
    strokeWidth: 0.5,
    scale: 1,
...
Progress.Radial = __webpack_require__(312);
Progress.Bar = __webpack_require__(311);
...
// module
exports.push([module.i, "._2Ym4i ._3Yct1 {\n  stroke: #dedede;\n}\n._2Ym4i ._25Lfy {\n  stroke: #3e98c7;\n  transition: stroke-dashoffset 0.5s ease 0s;\n}\n._2Ym4i .XaRR_ {\n  fill: #3e98c7;\n  font-size: 20px;\n  dominant-baseline: middle;\n  text-anchor: middle;\n}\n", ""]);
...
// module
exports.push([module.i, "._3GH8L ._2UAFZ {\n  stroke: #dedede;\n}\n._3GH8L ._1G9ub {\n  stroke: #3e98c7;\n  transition: stroke-dashoffset 0.5s ease 0s;\n}\n._3GH8L ._2q_TL {\n  fill: #3e98c7;\n  font-size: 20px;\n  dominant-baseline: middle;\n  text-anchor: middle;\n}\n", ""]);
