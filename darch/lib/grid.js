...
var Logger = new _utils.LoggerFactory("grid.cell", { level: "error" });
...
var Component = function (_React$Component) {
    ...
    _createClass(Component, [{
        ...
        value: function render() {
            ...
            var width = span / spots * 100;

            return _react2.default.createElement(
                "div",
                { className: _styles2.default.cell, style: { width: width + "%" } },
                this.props.children
            );
        }
    }]);
...
Component.displayName = "grid.cell";
...
Component.propTypes = {
    ...
    spots: _react2.default.PropTypes.number
};
...
var Logger = new _utils.LoggerFactory("grid", { level: "error" });
...
var Component = function (_React$Component) {
    ...
    _createClass(Component, [{
        ...
        value: function processChildren() {
            ...
            // Count cell children
            _react2.default.Children.forEach(this.props.children, function (component) {
                if (component.type.displayName == "grid.cell") {
                    spots += component.props.span || 1;
                }
            });

            logger.info("spots count", { spots: spots });

            return _react2.default.Children.map(this.props.children, function (component, idx) {
                ...
                // Total cell spots
                props.spots = _this3.props.spots || spots;

                // Span
                props.span = component.props.span;

                logger.info("children map : " + idx + " : props", { props: props });

                // Get children
                props.children = component.props.children;

                // Clone cell with new props
                return _lodash2.default.size(props) ? _react2.default.cloneElement(component, props) : component;
            });
        }
...
Component.Cell = __webpack_require__(302);
exports.default = Component;
module.exports = exports["default"];
