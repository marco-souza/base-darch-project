...
var Logger = new _utils.LoggerFactory("container", { level: "error" });
...
var Component = function (_React$Component) {
    ...
    _createClass(Component, [{
        ...
        value: function render() {
            var classes = [_styles2.default.container, this.props.className, this.props.size ? _styles2.default["container-" + this.props.size] : ""];
...
Component.propTypes = {
    size: _react2.default.PropTypes.oneOf(["sm", "md"])
};
