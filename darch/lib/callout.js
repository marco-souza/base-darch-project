(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("darch/lib/utils"), require("react"), require("darch/lib/i18n"));
	else if(typeof define === 'function' && define.amd)
		define(["darch/lib/utils", "react", "darch/lib/i18n"], factory);
	else if(typeof exports === 'object')
		exports["darch"] = factory(require("darch/lib/utils"), require("react"), require("darch/lib/i18n"));
	else
		root["darch"] = factory(root["darch/lib/utils"], root["react"], root["darch/lib/i18n"]);
...
var Logger = new _utils.LoggerFactory("callout", { level: "error" });
...
var Component = function (_React$Component) {
    ...
    _createClass(Component, [{
        ...
        value: function render() {
            ...
            color = _utils.Style.getColor(color);
            ...
            return _react2.default.createElement(
                "div",
                { className: _styles2.default.callout, style: style },
                title ? _react2.default.createElement(
                    "div",
                    { className: _styles2.default.title, style: titleStyle },
                    _react2.default.createElement(_i18n2.default.Translate, { text: title })
                ) : null,
                this.props.children
            );
        }
